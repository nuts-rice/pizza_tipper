...
pub use self::highlighted_pizzas::{
    HighlightedPizzasError, HighlightedPizzasRef, DELETE_PIZZA_SELECTOR, GET_BY_AUTHOR_SELECTOR,
    HIGHLIGHTED_CONTENT_SELECTOR, HIGHLIGHTED_PIZZA_SELECTOR, HIGHLIGHT_CONTENT_SELECTOR,
    HIGHLIGHT_PIZZA_SELECTOR,
};
...
mod highlighted_pizzas {
    ...
    impl HighlightedPizzas {
        ...
        pub fn new() -> Self {
            ...
            Self {
                created_by: caller,
                highlighted_pizzas: Mapping::default(),
                highlighted_content: Mapping::default(),
                highlighted_ids: Vec::new(),
                pizzas: Mapping::default(),
            }
        }
        ...
        pub fn add_content(
            ...
            if self.highlighted_content.contains(author) {
                ...
                Self::emit_event(
                    Self::env(),
                    Event::ContentHighlighted(ContentHighlighted { author, id }),
                );
                Ok(())
            }
        }
        ...
        pub fn delete_tip_by_author(
            ...
            if !self.highlighted_pizzas.contains(from) {
                Err(HighlightedPizzasError::HighlightNotFound)
            } else {
        ...
        pub fn delete_content_by_author(
            &mut self,
            author: AccountId,
        ) -> Result<(), HighlightedPizzasError> {
            if Self::env().caller() != self.created_by {
            ...
            if !self.highlighted_content.contains(author) {
                ...
                self.highlighted_ids
                    .retain(|content_from| content_from != &author);
                Self::emit_event(
                    Self::env(),
